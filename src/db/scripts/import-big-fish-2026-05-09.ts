...
const CARDS: Card[] = [
  ...
  { username: 'bgoettl',    scores: [5,5,3,4,4,4,6,5,4, 4,5,4,6,5,5,4,5,3] },
  // Collin Kowalczyk — 85 (43 + 42)
  { username: 'ckowalczyk', scores: [4,5,4,4,5,5,5,5,6, 5,6,3,6,4,5,4,5,4] },
  // Jacob Anderson — 83 (41 + 42)
  { username: 'janderson',  scores: [4,5,4,4,4,6,5,5,4, 5,3,3,5,4,7,6,5,4] },
  // Max Demulling — 84 (43 + 41)
  { username: 'mdemulling', scores: [6,6,4,4,4,5,6,4,4, 4,5,3,5,4,5,5,6,4] },
  // Asher Sikora — self-recorded
]
