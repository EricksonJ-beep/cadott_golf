...
const HOLES: HoleGuide[] = [
  {
    holeNumber: 1,
    generalStrategy:
      'Par 4, 332 yds | Hcp 18. "Opening Act." Welcoming opener with a left-bending fairway and a generous driving target. The real test starts on the green — Big Fish surfaces are exceptionally fast.',
    teeShotNotes:
  ...
  },
  {
    holeNumber: 2,
    generalStrategy:
      'Par 5, 513 yds | Hcp 8. "Rolling Thunder." Rolling fairway that filters right with significant mounding. The rightward tilt leaves a ball-below-feet stance for a long second — make tee shot position the priority.',
    teeShotNotes:
  ...
  },
  {
    holeNumber: 3,
    generalStrategy:
      'Par 3, 137 yds | Hcp 10. "The Sand Moat." Short, charming-looking par 3 with a multi-tiered green and a bunker moat down the left. Center pin is manageable; an upper or lower shelf turns this into one of the trickiest one-shotters on the course.',
    teeShotNotes:
  ...
  },
  {
    holeNumber: 4,
    generalStrategy:
      'Par 4, 387 yds | Hcp 2. "Sandstorm." One of the longest par 4s in Wisconsin from the tips. Sand lines the entire left side of the fairway; right of the green is just as punishing. The green is long front-to-back but narrow laterally — par is a great score.',
    teeShotNotes:
  ...
  },
  {
    holeNumber: 5,
    generalStrategy:
      'Par 4, 315 yds | Hcp 14. "The Serpent." A serpentine bunker splits the approach, pointing players toward long and left. Follow the architecture\'s intent and this is a real birdie opportunity — the best on the front nine.',
    teeShotNotes:
  ...
  },
  {
    holeNumber: 6,
    generalStrategy:
      'Par 4, 394 yds | Hcp 6. "Dye-Abolical." A punishing Pete Dye classic. The fairway tilts hard left, so even a right-side drive rolls toward trouble. The elevated green dumps short approaches into bunkers below — par is a great score.',
    teeShotNotes:
  ...
  },
  {
    holeNumber: 7,
    generalStrategy:
      'Par 5, 484 yds | Hcp 4. "The Signature." The most memorable hole on the front. Water lines the entire left side; the fairway slopes right-to-left toward the pond. Reachable in two if you can carry 230+ over the water threat.',
    teeShotNotes:
  ...
  },
  {
    holeNumber: 8,
    generalStrategy:
      'Par 4, 346 yds | Hcp 16. "Old Farmstead." Short, straightforward par 4 playing toward an old farm. Several deep pot bunkers guard the green — one of the more benign holes from the fairway, but bunkered recovery is tough.',
    teeShotNotes:
      'Lay up to the 150 marker — don\'t bomb driver into the pot bunkers.',
    approachNotes:
      'Mid-iron from 150 is the cleanest look. Center of the green, not at flags near sand.',
    aroundGreenNotes:
  ...
  },
  {
    holeNumber: 9,
    generalStrategy:
      'Par 3, 104 yds | Hcp 12. "Mulligan\'s Farewell." Deceptive front-nine finisher. The green tilts sharply uphill front-to-back; surrounding bunkers are among the most treacherous on the course. Halfway house waits just beyond.',
    teeShotNotes:
  ...
  },
  {
    holeNumber: 10,
    generalStrategy:
      'Par 4, 347 yds | Hcp 15. "Wide Open." Welcoming back-nine opener. The left side of the fairway is generous; the green is slightly elevated. A confidence-builder before the real challenge starts.',
    teeShotNotes:
  ...
  },
  {
    holeNumber: 11,
    generalStrategy:
      'Par 4, 285 yds | Hcp 17. "Tall Timber." Gorgeous par 4 tucked beyond the cart paths. Tee boxes sit deep among tall trees; both shots play through a narrower corridor than the yardage suggests.',
    teeShotNotes:
  ...
  },
  {
    holeNumber: 12,
    generalStrategy:
      'Par 3, 149 yds | Hcp 13. "High Wire." Highly elevated tee shot — plays shorter than the yardage. One of the best birdie opportunities on the course.',
    teeShotNotes:
  ...
  },
  {
    holeNumber: 13,
    generalStrategy:
      'Par 5, 475 yds | Hcp 9. "Best in Wisconsin." Widely regarded as one of the finest par 5s in the state. The hole funnels left and drops dramatically downhill to a small green nestled between trees on three sides.',
    teeShotNotes:
  ...
  },
  {
    holeNumber: 14,
    generalStrategy:
      'Par 4, 351 yds | Hcp 3. "Uphill Battle." Trees border the left side the entire hole; the tee shot can go right — even well right — as long as you don\'t reach the right tree line. Crowned green repels edge approaches.',
    teeShotNotes:
  ...
  },
  {
    holeNumber: 15,
    generalStrategy:
      'Par 4, 420 yds | Hcp 1. "The Beast." The #1 handicap hole and one of the hardest par 4s in Wisconsin. Long, tight, and relentlessly punishing. Bogey is a victory for most — play it like a par 5 in your head.',
    teeShotNotes:
  ...
  },
  {
    holeNumber: 16,
    generalStrategy:
      'Par 3, 171 yds | Hcp 11. "Precision Required." Signature Pete Dye par 3. A long waste area and sand trap run the full length of the approach. Absolute precision required.',
    teeShotNotes:
  ...
  },
  {
    holeNumber: 17,
    generalStrategy:
      'Par 5, 490 yds | Hcp 5. "The Penultimate." The right side of the fairway is much more open than it looks from the tee. Heavy mounding can leave awkward seconds. Pot bunkers guard front and right of the green.',
    teeShotNotes:
  ...
  },
  {
    holeNumber: 18,
    generalStrategy:
      'Par 4, 384 yds | Hcp 7. "Perched Finish." A fitting finale on a thin, perched green that runs downhill from middle to back. False front is merciless — anything short returns to your feet.',
    teeShotNotes:
