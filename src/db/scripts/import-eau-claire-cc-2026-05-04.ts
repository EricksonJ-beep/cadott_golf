...
const COURSE_NAME = 'Eau Claire Country Club'
const DATE = '2026-05-04'
// Tournament tee yardage (6202) does not match stored blue/white — teeColor left null
const TEE_COLOR = null
const PARS = [4, 4, 4, 3, 4, 3, 4, 4, 5, 4, 4, 3, 5, 4, 4, 3, 4, 5]

type Card = { username: string; scores: number[] }

const CARDS: Card[] = [
  // Brady Goettl — 80 (+9)
  { username: 'bgoettl',    scores: [5,5,4,4,4,3,4,4,6, 4,5,4,4,6,4,4,4,6] },
  // Collin Kowalczyk — 91 (+20)
  { username: 'ckowalczyk', scores: [5,4,6,5,6,5,5,5,6, 4,4,4,5,6,5,6,5,5] },
  // Jacob Anderson — 98 (+27)
  { username: 'janderson',  scores: [9,5,5,3,7,3,6,4,7, 4,6,5,5,5,5,4,9,6] },
  // Max Demulling — 95 (+24)
  { username: 'mdemulling', scores: [5,7,6,5,5,5,6,4,4, 4,5,6,5,6,5,4,7,6] },
  // Gavin Roscoe — 95 (+24)
  { username: 'groscoe',    scores: [6,5,5,3,6,6,5,5,5, 7,5,4,6,4,6,4,7,6] },
]
  ...
  for (const card of CARDS) {
    ...
    const [round] = await db
      ...
      .values({
        ...
        totalScore,
        weatherNotes: null,
        freeTextNotes: 'Chippewa Valley Championship — imported from tournament scorecard',
        seasonId,
      })
