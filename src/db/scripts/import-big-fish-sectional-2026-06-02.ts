...
const COURSE_NAME = 'Big Fish Golf Club'
const DATE = '2026-06-02'
const TEE_COLOR = 'blue'
const PARS = [4, 5, 3, 4, 4, 4, 5, 4, 3, 4, 4, 3, 5, 4, 4, 3, 5, 4]

type Card = { username: string; scores: number[] }

const CARDS: Card[] = [
  // Brady Goettl — 86 (+14)
  { username: 'bgoettl',    scores: [3,4,3,7,5,4,7,4,2, 6,5,2,6,9,5,3,7,4] },
  // Collin Kowalczyk — 90 (+18)
  { username: 'ckowalczyk', scores: [5,7,4,4,4,5,5,4,4, 5,5,4,7,6,7,3,5,6] },
  // Jacob Anderson — 97 (+25)
  { username: 'janderson',  scores: [4,5,4,7,5,4,5,5,4, 5,7,4,7,7,7,5,7,5] },
  // Max Demulling — 96 (+24)
  { username: 'mdemulling', scores: [6,4,4,6,5,4,8,6,2, 5,5,3,6,6,9,4,8,5] },
  // Gavin Roscoe — 96 (+24)
  { username: 'groscoe',    scores: [5,6,4,6,6,4,5,4,3, 6,6,5,7,5,8,5,6,5] },
]
  ...
  for (const card of CARDS) {
    ...
    const [round] = await db
      ...
      .values({
        ...
        totalScore,
        weatherNotes: null,
        freeTextNotes: '2026 WIAA Boys D3 Sectional 1 — imported from tournament scorecard',
        seasonId,
      })
