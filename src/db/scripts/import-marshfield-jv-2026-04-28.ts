...
const COURSE_NAME = 'Marshfield Country Club'
const DATE = '2026-04-28'
// Scorecard yardage (3005) falls between white (2976) and blue (3140) — tournament markers.
const TEE_COLOR = null
const PARS = [4, 3, 4, 5, 4, 3, 4, 4, 4] // front 9 only, sum = 35
...
const CARDS: Card[] = [
  // Asher Sikora — 48 (+13)
  { username: 'asikora',  scores: [7,4,5,6,5,4,5,7,5] },
  // Connor Goettl — 50 (+15)
  { username: 'cgoettl',  scores: [5,5,5,7,5,5,6,6,6] },
]
  ...
  for (const card of CARDS) {
    ...
    const [round] = await db
      ...
      .values({
        ...
        totalScore,
        weatherNotes: null,
        freeTextNotes: 'Imported from JV match scorecard (Cloverbelt JV Match #4)',
        seasonId,
      })
