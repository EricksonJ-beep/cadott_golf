...
const PARS = [4, 3, 4, 4, 5, 4, 4, 3, 4] // front 9, sum = 35
...
const CARDS: Card[] = [
  // Connor Goettl — 48 (+13)
  { username: 'cgoettl',  scores: [4,4,5,5,6,6,7,5,6] },
  // Michael Wellner — 53 (+18)
  { username: 'mwellner', scores: [5,5,6,7,8,6,5,6,5] },
]
  ...
  for (const card of CARDS) {
    ...
    const [round] = await db
      ...
      .values({
        ...
        totalScore,
        weatherNotes: null,
        freeTextNotes: 'Imported from JV match scorecard (Cloverbelt JV Match #1)',
        seasonId,
      })
